...
class Metropolis:
    ...
    def __call__(self, x, r, R, a, b, nRand, dRand):
        '''Updates position and PsiRatio'''

        if self.Sampling == "BruteForce":
            return self.BruteForce(x, r, R, a, b, nRand, dRand)
        elif self.Sampling == "ImportanceSampling":
            return self.ImportanceSampling(x, r, R, a, b, nRand, dRand)

    def BruteForce(self, x, r, R, a, b, nRand, dRand):
        ...
        PsiRatio = self.Psi(a, b, rNew, RNew)/self.Psi(a, b, r, R)
        return xNew, rNew, RNew, PsiRatio
        
    def ImportanceSampling(self, x, r, R, a, b, nRand, dRand):
